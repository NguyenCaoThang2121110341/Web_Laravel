...
@section('content')
@section('title', 'Sản phẩm thuộc danh mục đã bị xóa')
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sản phẩm thuộc danh mục: {{ $category->name }} (ĐÃ BỊ XÓA)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">Trang chủ</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.category.show',['id'=>$category->id]) }}">Chi tiết danh mục</a></li>
                        <li class="breadcrumb-item active">Sản phẩm thuộc danh mục đã bị xóa</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        @foreach ($list_trash_pro_by_cate as $row)
                            <tr>
