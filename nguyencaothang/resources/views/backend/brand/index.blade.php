                ...
                <div class="row mb-2">
                    <div class="col-sm-12 row">
                        ...
                        <div class="col-md-2 text-right">
                            <a href="{{ route('admin.brand.trash') }}" class="text-danger"><i class="fa fa-trash"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="datarow">
                                        ...
                                        <td>
                                        @if ($row->status == 1)
                                                    <a href="{{ route('admin.brand.status', $agrs) }}"
                                                ...
                                                @endif
                                            <a class="btn btn-sm btn-success" href="{{route('admin.brand.edit',$agrs)}}">
